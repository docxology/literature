...
Examples:
  ...
  python3 scripts/literature_search.py --search --keywords "machine learning,optimization"
  python3 scripts/literature_search.py --search --limit 50 --keywords "AI"

  # INDIVIDUAL OPERATIONS
  # Search and add to bibliography only
  python3 scripts/literature_search.py --search-only
  python3 scripts/literature_search.py --search-only --keywords "machine learning,optimization"
  ...
  python3 scripts/literature_search.py --llm-operation communication --paper-config my_papers.yaml
