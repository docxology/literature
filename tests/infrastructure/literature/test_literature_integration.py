"""Integration tests for literature search module.

These tests use API calls, PDF downloads, and library operations
to verify functionality. Requires network access and may take time.
"""
...
class TestLiteratureSearch:
    """Literature search tests with API calls."""
    ...
    def real_config(self, tmp_path):
        ...
        config.arxiv_delay = 1.0  # Realistic delay for API
        config.semanticscholar_delay = 0.5
        config.retry_attempts = 2
        config.sources = ["arxiv", "semanticscholar"]
        return config

    def test_search_arxiv(self, real_config):
        """Test arXiv search."""
    ...
    def test_search_semanticscholar(self, real_config):
    ...
    def test_search_multiple_sources(self, real_config):
    ...
    def test_search_with_statistics(self, real_config):
...
class TestPDFDownload:
    """PDF download tests with downloads."""
    ...
    def test_pdf_download_arxiv(self, real_config):
    ...
    def test_pdf_download_with_fallbacks(self, real_config):
        """Test PDF download with fallback strategies."""
        searcher = LiteratureSearch(real_config)
        ...
        result = SearchResult(
            ...
            source="test",
            pdf_url=None,
            doi="10.1162/neco_a_00912"  # DOI for testing
        )
...
class TestLibraryManagement:
    ...
    def test_add_to_library(self, real_config):
    ...
    def test_library_deduplication(self, real_config):
    ...
    def test_library_stats(self, real_config, real_library_entries):
        ...
        for result in results[:2]:
            if result.pdf_url:
                try:
                    ...
                    # for integration tests - some papers are access-restricted
